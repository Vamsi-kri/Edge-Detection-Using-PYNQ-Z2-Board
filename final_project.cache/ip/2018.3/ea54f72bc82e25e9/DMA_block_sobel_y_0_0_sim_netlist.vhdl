...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_FIR_Vertical_y is
  ...
  signal sobel_out_signed_vertical : STD_LOGIC_VECTOR ( 10 downto 0 );
  ...
  signal \y_reg[10]_i_1_n_2\ : STD_LOGIC;
  signal \y_reg[10]_i_1_n_3\ : STD_LOGIC;
  signal \y_reg[10]_i_1_n_6\ : STD_LOGIC;
  signal \y_reg[10]_i_1_n_7\ : STD_LOGIC;
  ...
  signal \NLW_y_reg[10]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_y_reg[10]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of \m00_axis_tdata[4]_INST_0\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \x_reg_gate__4\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \x_reg_gate__5\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \x_reg_gate__7\ : label is "soft_lutpair5";
begin
...
\y[10]_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\y[10]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"99999A99"
    )
        port map (
...
\y[10]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"99999699"
    )
        port map (
...
\y_reg[10]_i_1\: unisim.vcomponents.CARRY4
     port map (
      CI => \y_reg[7]_i_1_n_0\,
      CO(3 downto 2) => \NLW_y_reg[10]_i_1_CO_UNCONNECTED\(3 downto 2),
      CO(1) => \y_reg[10]_i_1_n_2\,
      CO(0) => \y_reg[10]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \y[10]_i_2_n_0\,
      DI(0) => p_0_in,
      O(3) => \NLW_y_reg[10]_i_1_O_UNCONNECTED\(3),
      O(2) => p_1_in,
      O(1) => \y_reg[10]_i_1_n_6\,
      O(0) => \y_reg[10]_i_1_n_7\,
      S(3 downto 2) => B"01",
      S(1) => \y[10]_i_3_n_0\,
      S(0) => \y[10]_i_4_n_0\
    );
